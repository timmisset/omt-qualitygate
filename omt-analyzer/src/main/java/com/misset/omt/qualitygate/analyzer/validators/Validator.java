 ...
 * Use com.misset.omt.qualitygate.analyzer.validators when the same check should be performed on different levels. For example, Prefix usage should be performed
